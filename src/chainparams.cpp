...
{
    const char* pszTimestamp = "EU triggers unprecedented proceedings against Poland, sanctions could follow";
    const CScript genesisOutputScript = CScript() << ParseHex("657294710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1513778374, 439406, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x518b1d7d78729e3f0eaef42d558ae10f8ce098eb673335f2189abc6883d6a177"));
        assert(genesis.hashMerkleRoot == uint256S("0xe55114f1d60b0fa107a523e8a9bbca45e4f9870c04a837cf7fe06fd9e185b1f0"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("netapp.work", "elsa.netapp.work", false));
        vSeeds.push_back(CDNSSeedData("kryptokoruna.net", "node1.kryptokoruna.net", false));
        vSeeds.push_back(CDNSSeedData("nrjplus.sk", "gate.nrjplus.sk", false));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("kryptokorunatools.com", "testnet-seed.kryptokorunatools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.kryptokoruna.loshan.co.uk", true));
