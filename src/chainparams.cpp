...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.favorcoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("favorcointools.com", "dnsseed.favorcointools.com"));
        vSeeds.push_back(CDNSSeedData("favorcoinpool.org", "dnsseed.favorcoinpool.org"));
